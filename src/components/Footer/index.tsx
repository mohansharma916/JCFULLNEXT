    ...
    <>
      <footer className="pt-10 bg-gray-800">
        <div className="max-w-screen-xl mx-auto px-4 md:px-8">
          <div className="justify-end flex items-center gap-12 md:flex">
            ...
            <div className="flex-1 mt-6 md:mt-0">
              ...
              >
                ...
                <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-[#FAA935] hover:bg-indigo-500 active:bg-indigo-700 active:shadow-none rounded-lg shadow">
                  Subscribe
                </button>
              </form>
            </div>
          </div>
          <div className="flex-1 mt-16 space-y-6 justify-between  flex sm:flex md:space-y-0">
          ...
          <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
            <p className="text-gray-300">
              © 2023 Journey Capturer || All rights reserved.
            </p>
            <div className="flex items-center gap-x-6 text-gray-400 mt-6">
              ...
              <a href="https://www.instagram.com/thejourneycapturer/">
                <svg
                  className="w-6 h-6 hover:text-gray-500 duration-150"
                  fill="currentColor"
                  viewBox="0 0 48 48"
