...
export default () => {
  return (
    <>
      ...
      <p>
        Welcome to "The Journey Capturer" (referred to as "we," "our," or "us").
        We respect your privacy and are committed to protecting your personal
        information. This Privacy Policy is designed to help you understand how
      ...
      <p>
        ...
        name, email address, and contact details when you register on our
        website or use our services. Trip Details: When you book a trip, we may
        collect information related to your travel plans and preferences.
        Payment Information: If applicable, we collect payment information for
        trip reservations. Cookies and Tracking Technologies: We use cookies and
        similar tracking technologies to enhance your experience on our website.
        You can manage your cookie preferences through your browser settings.
      </p>
      <h2>3. How We Use Your Information</h2>
      <ul>
        <li>To provide, personalize, and improve our services.</li>
        <li>To process your trip reservations and payments.</li>
      ...
      <p>
        ...
        in our practices. We will notify you of any significant changes through
